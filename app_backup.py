...
if st.session_state.get("user") is None:
    # --- everything from "Menu" selectbox down through Login/Sign Up forms ---
...
with st.sidebar:
    ...
    page = st.radio(
        label="Navigation",
        options=["Dashboard", "Properties", "Tenants", "Payments", "My Bookings", "Reports"]
    )
    st.divider()
    st.write("Settings")
